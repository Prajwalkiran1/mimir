...
const Dashboard = () => {
  const recentActivity = [
    { id: 1, filename: 'product_demo.mp4', type: 'Transcript', time: '2 hours ago' },
    { id: 2, filename: 'meeting_recording.mp4', type: 'Summary', time: '5 hours ago' },
    { id: 3, filename: 'tutorial_video.mp4', type: 'Subtitles', time: '1 day ago' },
  ];

  const quickStats = [
    { label: 'Videos Processed', value: '42', icon: <FileVideo className="w-6 h-6" />, color: 'bg-blue-500' },
    { label: 'Total Minutes', value: '156', icon: <Clock className="w-6 h-6" />, color: 'bg-green-500' },
    { label: 'Accuracy Rate', value: '99.5%', icon: <Target className="w-6 h-6" />, color: 'bg-purple-500' },
    { label: 'Downloads', value: '128', icon: <Download className="w-6 h-6" />, color: 'bg-orange-500' },
  ];
